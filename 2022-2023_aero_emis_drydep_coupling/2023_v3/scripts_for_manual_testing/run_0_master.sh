...
readonly CASE_NAME="master_202302"
...
readonly BRANCH="master"             # This is the branch in ${repo} to be cloned.
readonly CHECKOUT="v3atm_master_202302"  # This is the local subdir into which the E3SM code will be cloned
