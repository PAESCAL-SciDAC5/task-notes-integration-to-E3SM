...
readonly CASE_NAME="cflx_opt_1_202302"
...
readonly BRANCH="huiwanpnnl/atm/aerosol-process-coupling-202302"  # This is the branch in ${repo} to be cloned.
readonly CHECKOUT="v3atm_master_202302_with_clfx_new_imp"         # This is the local subdir into which the E3SM code will be cloned
